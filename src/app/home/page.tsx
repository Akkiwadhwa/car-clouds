  ...
  return (
    <div className="bgcar h-screen w-screen overflow-hidden">
      <div className="flex h-[30%]">
        ...
        <div className="text-white justify-center flex items-center w-[20%] text-lg md:text-xl font-bold gap-3 p-5">
      ...
      <div className="h-full flex">
        <div className="h-[70%] flex w-[60%] mt-10 flex-col">
          <div className="flex justify-center ml-14 font-bold flex-col">
            <span className="text-white text-4xl font-sans md:text-5xl lg:text-7xl">
              Get The Most For Your Car with Car Clouds
            </span>
            <h3 className="font-thin text-white text-lg md:text-xl">
          ...
          <div className="justify-center flex h-fit  ">
            <div className="bg-gray-200 shadow-xl h-40 mt-10 flex flex-col rounded-lg w-[90%] p-6">
              ...
              <div className="flex gap-4 mt-5 md:flex-row flex-col">
                <input
                  ...
                  className="w-[14rem] md:w-[18rem] lg:w-[22rem] bg-white text-lg md:text-xl border-1 text-black border-slate-400 placeholder:font-bold placeholder:text-2xl md:placeholder:text-3xl lg:placeholder:text-4xl placeholder:text-center placeholder:font-serif h-14 rounded-md"
                />
          ...
          <div className="text-black text-2xl flex justify-center h-full mt-5">
            <div className="h-fit flex items-center p-4 w-[90%] font-sans">
              <span>
              ...
              <Image
                ...
                width={300}
                height={50}
                className="ml-2 mt-1" // Adds spacing between the text and image
              />
            </div>
          </div>
        </div>

        <div className="overflow-hidden flex justify-end h-[70%] w-[40%]">
          <Image
            src="/car.png"
            alt="Car with clouds"
            width={700}
